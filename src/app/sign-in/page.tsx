        ...
        <main className="flex min-h-screen flex-col items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <Card className="w-full max-w-md shadow-2xl bg-card/80 backdrop-blur-xl border-white/10 dark:border-white/5 z-10">
                <CardHeader className="text-center space-y-2">
                    ...
                    <CardDescription className="text-muted-foreground">Sign in to your society management dashboard.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                 ...
                 <CardFooter className="flex flex-col space-y-4 text-center">
                    <div className="text-sm text-muted-foreground">
                        Don't have an account? <Link href="/sign-up" className="font-semibold text-primary hover:text-primary/80 transition-colors">Register Society</Link>
                    </div>
                </CardFooter>
            </Card>
        </main>
